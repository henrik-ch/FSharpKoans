...
type ``about lists``() =
    ...
    (* THINK ABOUT IT: In general, what performs better for building lists, 
       :: or @? Why?
       //Henrik: I think the :: cons perform better, because the list can be used as is, no need to read through it.
       ...
       // put in all the data in a new list, and then append the last one. /HK
    ...
    member this.DividingListsWithPartition() =
        ...
        AssertEquality result1 [1..2..5]
        AssertEquality result2 [0..2..5]
